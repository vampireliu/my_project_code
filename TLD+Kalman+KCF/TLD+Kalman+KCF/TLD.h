...
public:
  ...
  void processFrame(const cv::Mat& img1, cv::Mat& img2,
	  BoundingBox& bbnext, bool& lastboxfound, bool tl, FILE* bb_file, cv::Mat& frame, cv::Rect & box);

//kcf tracker
  void KCFtracker(cv::Mat & img2, cv::Mat& frame, cv::Rect &box);
